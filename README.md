...
マウスの右クリック＋ドラッグでカメラを回転可能

カードマッチングゲームプレイ

カードをクリックして裏返すことができます

2枚のカードを裏返すと、ゲームが一致するかどうかを確認します
...
すべてのカードが3Dビューポートに描画されます

Phongライティングを使用してリアルな陰影効果を実現

実行方法

Card Matching Game.exe を開いてゲームを開始してください

必要なDLL（例：glfw3.dll）が実行ファイルと同じフォルダにあることを確認してください
